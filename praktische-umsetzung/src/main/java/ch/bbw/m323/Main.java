...
public class Main {
    public static void main(String[] args) {
        ...
        // Natural Order (already implemented in Student class by studentId)
        ...
        // Reverse Order (of Natural Order)
        ...
        // Comparator: Derived Class (Sort by Age)
        ...
        // Comparator: Anonymous Class (Sort by GPA descending)
        ...
        // Comparator: Lambda Expression (Sort by Last Name, then First Name)
        ...
        // Comparator: Comparator Chain (Sort by Major, then GPA descending)
        ...
        studentsSortedByMajorThenGpa.sort(
                Comparator.comparing(Student::getMajor) // Sort by Major first
                        .thenComparing(Student::getGpa, Comparator.reverseOrder()) // Then by GPA descending
        );
        studentsSortedByMajorThenGpa.forEach(System.out::println);

        // Comparator: Using a comparator for enrollmentDate
        ...
        List<Course> courses = DataGenerator.generateCourses(20);
        List<Lecturer> lecturers = DataGenerator.generateLecturers(5, courses);
        ...
        lecturersByCourseCount.sort(Comparator.comparingInt((Lecturer l) -> l.getCoursesTaught().size()).reversed());
        ...
        coursesByLecturerThenName.sort(
                Comparator
                        .comparing((Course c) -> c.getLecturer() != null ? c.getLecturer().getName() : "",
        ...
        System.out.println("   - For Arrays of Primitives: `Arrays.sort(primitive[])` uses different algorithms:");
        System.out.println(
        ...
        System.out.println("      - `List.sort(Comparator<? super E> c)`: Default method in List interface (Java 8+).");
        System.out.println(
        ...
        // Ensure all attributes are used for sorting at least once:
        ...
        // Mehrstufige Sortierungen (Multi-level sorting) is demonstrated by:
